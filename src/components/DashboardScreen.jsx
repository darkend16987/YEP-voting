...
const ScoreBar = ({ item, index, maxScore, previousRank }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`relative bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl transition-all duration-500 ${isLeader
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-2 gap-3 sm:gap-6 mb-4 sm:mb-8">
        ...
        {secondPlace && (
          ...
          >
            ...
            <div className="relative bg-white/90 border border-secondary-200 rounded-2xl p-6 text-center shadow-lg">
        ...
        {thirdPlace && (
          ...
          >
            ...
            <div className="relative bg-white/90 border border-amber-200 rounded-2xl p-6 text-center shadow-lg">
        ...
        >
          ...
          <div className="space-y-3">
            {scores.slice(3).map((item, idx) => (
              <div
                key={item.id}
                className="bg-white/90 border border-secondary-200 rounded-xl p-4 flex items-center justify-between shadow-sm"
              >
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-white relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 pb-24 sm:pb-12">
        <div className="bg-white/90 backdrop-blur-md rounded-xl sm:rounded-2xl border border-secondary-200 p-3 sm:p-6 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 shadow-lg">
