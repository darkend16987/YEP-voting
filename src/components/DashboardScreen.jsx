...
const ScoreBar = ({ item, index, maxScore, previousRank }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`relative bg-white backdrop-blur-sm rounded-xl sm:rounded-2xl transition-all duration-500 ${isLeader
        ? 'border border-yellow-400/50 shadow-lg shadow-yellow-500/10 p-3 sm:p-6 scale-[1.01] sm:scale-[1.02]'
        : 'border border-slate-200 shadow-sm p-3 sm:p-4'
        }`}>
...
const FinalResultsView = ({ scores, totalVotes }) => {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-screen text-slate-800 py-6 sm:py-12 px-3 sm:px-6 pb-24"
    >
      {/* Header - Responsive */}
      <motion.div
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-2 gap-3 sm:gap-6 mb-4 sm:mb-8">
        ...
        {secondPlace && (
          ...
          >
            ...
            <div className="relative bg-white/70 border border-secondary-200 rounded-2xl p-6 text-center shadow-lg">
        ...
        {thirdPlace && (
          ...
          >
            ...
            <div className="relative bg-white/70 border border-amber-200 rounded-2xl p-6 text-center shadow-lg">
        ...
        >
          ...
          <div className="space-y-3">
            {scores.slice(3).map((item, idx) => (
              <div
                key={item.id}
                className="bg-white/70 border border-secondary-200 rounded-xl p-4 flex items-center justify-between shadow-sm"
              >
...
const DashboardScreen = ({ onExit }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary-400 via-secondary-200 to-primary-200 text-slate-800 relative overflow-hidden font-sans">
      ...
      {/* Header - Responsive */}
      <div className="sticky top-0 z-20 bg-slate-950/80 backdrop-blur-xl border-b border-white/5 safe-area-top text-white">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 pb-24 sm:pb-12">
        <div className="bg-white backdrop-blur-md rounded-xl sm:rounded-2xl border border-slate-200 p-3 sm:p-6 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 shadow-lg">
