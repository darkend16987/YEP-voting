...
const ScoreBar = ({ item, index, maxScore, previousRank }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`relative bg-white/70 backdrop-blur-sm rounded-xl sm:rounded-2xl transition-all duration-500 ${isLeader
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary-400 via-secondary-200 to-primary-200 text-slate-800 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 pb-24 sm:pb-12">
        <div className="bg-white/70 backdrop-blur-md rounded-xl sm:rounded-2xl border border-secondary-200 p-3 sm:p-6 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 shadow-lg">
